...
const achievements = [
  {
    ...
    description: "Mbi 50+ projekte të suksesshme të zhvilluara për klientët në Tiranë dhe më gjerë."
  },
  {
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-12 leading-relaxed">
              ...
              inovative për bizneset në Tiranë.
            </p>
          </motion.div>
        </div>
      </motion.section>
