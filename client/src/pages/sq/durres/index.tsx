  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-12 text-center">Shërbimet Tona në Durrës</h2>
      ...
      <section className="py-20 bg-muted/50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-12 text-center">Zonat që Mbulojmë në Durrës</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {['Plazh', 'Qendër', 'Currila', 'Kënetë', 'Spitallë'].map((area, index) => (
              <motion.div
                key={area}
