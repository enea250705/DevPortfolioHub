...
const services = [
  {
    ...
    description: "Website profesionale për biznesin tuaj në Korçë, të optimizuara për kërkim dhe shpejtësi.",
  ...
  {
    title: "E-commerce",
    description: "Platforma e-commerce të fuqishme për biznesin tuaj online në Korçë.",
    ...
    <div className="min-h-screen">
      ...
      >
        <div className="container mx-auto px-4">
          ...
          >
            Zhvillues Web Profesional në Korçë
          </motion.h1>
          <motion.p 
          ...
          >
            Zgjidhje dixhitale profesionale për bizneset në Korçë. 
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-12 text-center">Shërbimet Tona në Korçë</h2>
